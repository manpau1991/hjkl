...
\begin{remark}[Eigenschaften der Fouriertransformation und deren graphische Deutung] \leavevmode
  ...
  \begin{figure}[ht]
    ...
    Diese Eigenschaften sind vor allem nützlich fürs Rechnen.
		...
		man als inverse Fouriertransformation. Dass sich die Nützlichkeit einer Transformation auch
		daraus ergibt, die Transformation wieder umkehren zu können, braucht an dieser Stelle nicht
