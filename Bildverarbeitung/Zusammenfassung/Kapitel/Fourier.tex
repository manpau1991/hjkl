...
\begin{remark}[Eigenschaften der Fouriertransformation und deren graphische Deutung] \leavevmode
  ...
  \begin{figure}[ht]
    ...
    \]
    Eine Faltung im Zeitbereich wird also überführt in eine Multiplikation im Frequenzbereich.
    \TODO{Manuel: Du hattest da so eine schöne Erklärung hierfür, kannst du das hier kurz 
    beschrieben?}
    Dies ist eine extrem wichtige Eigenschaft der Fouriertransformation. Denn: Die Berechnung einer
    Faltung zweier Funktionen ist normalerweise viel aufwendiger als die beiden Funktionen einfach
    punktweise zu multiplizieren. Diese Eigenschaft kann man sich zunutze machen, um Filter mithilfe
    der Schnellen Fouriertransformation (FFT) effizient zu implementieren.
    \TODO{Stimmt das? Gibt es hier eine bessere Argumentation, warum diese Eigenschaft wichtig ist?}
