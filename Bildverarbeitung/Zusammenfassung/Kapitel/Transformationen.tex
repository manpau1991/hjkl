...
In der Wavelet-Analysis ist $ F_{0} $ normalerweise ein \enquote{Tiefpassfilter} und $ G_{0} $ ein 
...
Wir schieben nun die Analyse-Filterbank etwas beiseite und konzentrieren uns auf die 
...
\begin{tikzpicture}
  ...
  \draw [->,thick] (0,0) -- (0,4);
  \draw [fill=blue,opacity=0.25] (-4,0) -- (-2,1.5) -- (0,0) -- cycle;
  \draw [fill=blue,opacity=0.25] (0,0) -- (2,1.5) -- (4,0) -- cycle;
  \draw [fill=blue,opacity=0.25] (-2,0) -- (0,3) -- (2,0) -- cycle;
  \draw [red, thick] (-4,0) -- (0,3) -- (4,0);
\end{tikzpicture}
