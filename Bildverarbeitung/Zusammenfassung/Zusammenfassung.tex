...
\begin{figure}[ht]
	...
	\centering
	\includegraphics[width=\linewidth]{Bilder/Skalierung.jpg}
	\end{minipage}
	\begin{minipage}{0.49\linewidth}
	\centering
	\includegraphics[width=\linewidth]{Bilder/Skalierung.png}
	\end{minipage}
	\caption{\TODO{Das linke Bild ist irreführend, da
	es keine Skalierung zeigt (Veränderung der Periodenlänge), sondern eine Veränderung der 
	Amplitude. $ \sin(h \cdot \bullet) $ ist etwas anderes als $ h \cdot \sin(\bullet) $. Ich meine,
	dass das rechte Bild korrekt ist.}}
	\label{fig:L1}
\end{figure}
\end{enumerate}
\end{definition}
